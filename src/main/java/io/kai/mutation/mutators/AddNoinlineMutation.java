...
public class AddNoinlineMutation implements IMutationPolicy {
    @Override public Set<Class<? extends IBuilder>> targetTypes() { return Set.of(FunctionBuilder.class); }
    @Override public String id() { return "add_noinline"; }
    @Override
    ...
    @Override public IBuilder apply(IBuilder builder, MutationContext ctx) {
        ...
        fn.addParam(new Parameter(paramName, "() -> Unit", null, false, false, true));
        return fn;
    }
}
