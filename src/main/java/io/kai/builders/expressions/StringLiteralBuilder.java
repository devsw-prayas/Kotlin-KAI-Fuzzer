...
public class StringLiteralBuilder implements IExpressionBuilder {
    private final String id;
    private final NameRegistry registry;
    private final String value;

    public StringLiteralBuilder(NameRegistry registry, String val){
        this.registry = registry;
        this.id = registry.next("str_lit");
        this.value = val;
    }
    @Override
    public String id() {
